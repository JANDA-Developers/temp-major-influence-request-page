...
import partners1 from "./img/partners1.jpg";
import partners2 from "./img/partners2.jpg";
import partners3 from "./img/partners3.jpg";
import partners4 from "./img/partners4.jpg";
import partners5 from "./img/partners5.jpg";
import partners6 from "./img/partners6.jpg";
import partners7 from "./img/partners7.jpg";
    ...
    <div className="Main">
      ...
      <section id="mainvisual">
        <div className="mainvisual">
          <div className="txt_wrap">
            ...
            <p className="txt">
              만족도 최고의 <strong>MAGERNCY</strong>
            </p>
          </div>
      ...
      <section id="container">
        <div className="row1">
          ...
          <ul>
            <li>
              <a href="http://sum-nampogarosu.kr/" target="_blank">
                <span className="list_img">
                  <img src={rowimg1} alt="숨게스트하우스남포가로수길점"></img>
                </span>
                <span className="list_tit">SUM 남포 가로수길점</span>
                <span className="like">
            ...
            <li>
              <a href="http://partyguesthouse.kr/" target="_blank">
                <span className="list_img">
                  <img src={rowimg2} alt="파티게스트하우스중앙동점"></img>
                </span>
                <span className="list_tit">파티게스트하우스 중앙동점</span>
                <span className="like">
                  <span className="like_icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span className="like_txt">53</span>
                  </span>
                </span>
              </a>
            </li>
            <li>
              <a
                href="http://jeju.sumhostel.com/00main/main.php"
                target="_blank"
              >
                <span className="list_img">
                  <img src={rowimg3} alt="숨게스트하우스제주점"></img>
                </span>
                ...
                <span className="like">
                  <span className="like_icon">
                    ...
                    <span className="like_txt">70</span>
                  </span>
                </span>
              </a>
            </li>
            <li>
              <a href="http://mintguesthouse.com/" target="_blank">
                <span className="list_img">
                  <img src={rowimg4} alt="민트게스트하우스제주점"></img>
                </span>
                <span className="list_tit">민트 게스트하우스 제주점</span>
                <span className="like">
                  <span className="like_icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span className="like_txt">89</span>
                  </span>
                </span>
              </a>
            </li>
            <li>
              <a href="http://minthouse-busan.kr/" target="_blank">
                <span className="list_img">
                  <img src={rowimg5} alt="민트게스트하우스부산점"></img>
                </span>
                <span className="list_tit">민트 게스트하우스 부산점</span>
                <span className="like">
                  <span className="like_icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span className="like_txt">46</span>
                  </span>
                </span>
              </a>
            </li>
            <li>
              <a
                href="http://busan.tourbiz.or.kr/kor/CMS/Contents/Contents.do?mCode=MN037"
                target="_blank"
              >
                <span className="list_img">
                  <img src={rowimg6} alt="부산관광기업지원센터"></img>
                </span>
                <span className="list_tit">부산관광기업지원센터 대관신청</span>
                <span className="like">
                  <span className="like_icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span className="like_txt">33</span>
                  </span>
                </span>
              </a>
            </li>
            <li>
              <a href="https://www.unknownhotel.com/" target="_blank">
                <span className="list_img">
                  <img src={rowimg7} alt="담양언노운호텔"></img>
                </span>
                ...
                <span className="like">
                  <span className="like_icon">
                    ...
                    <span className="like_txt">42</span>
                  </span>
                </span>
              </a>
            </li>
        ...
        <div className="row3">
          <h2 className="row_tit">누구와 함께하나요?</h2>
          <p className="row_txt">
            메이전시와 함께하는 협력업체 입니다.<br></br>더 나은 서비스 제공을
            위해 오늘도 함께 노력하고 있습니다.
          </p>
          <div className="partners_area">
            <ul>
              <li>
                ...
                <span className="partners_name">잔다솔루션</span>
              </li>
              <li>
                <img src={partners2} alt="아마존"></img>
                <span className="partners_name">아마존웹서비스</span>
              </li>
              <li>
                <img src={partners3} alt="중소벤처기업부"></img>
                <span className="partners_name">중소벤처기업부</span>
              </li>
              <li>
                <img src={partners4} alt="기술보증기금"></img>
                <span className="partners_name">기술보증기금</span>
              </li>
              <li>
                <img src={partners5} alt="나이스페이먼츠"></img>
                <span className="partners_name">나이스페이먼츠</span>
              </li>
              <li>
                <img src={partners6} alt="부산광역시"></img>
                <span className="partners_name">부산광역시</span>
              </li>
              <li>
                <img src={partners7} alt="공유경제부산"></img>
                <span className="partners_name">공유경제부산</span>
              </li>
            </ul>
          </div>
        </div>
