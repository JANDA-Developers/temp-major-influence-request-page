  ...
  return (
    <div className="Sub">
          ...
          <JDslider
            prevArrow={
              <button className="slick-prev">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 12.52 22.63"
                >
                  <defs>
                    <style
                      dangerouslySetInnerHTML={{
                        __html: ".cls-8{fill:#3d3d3d;}",
                      }}
                    />
                  </defs>
                  <rect
                    ...
                    width="1.7"
                    height={16}
                    transform="translate(-286.77 -1047.69) rotate(45)"
                  />
                  <rect
                    className="cls-8"
                    x="958.75"
                    ...
                    width="1.7"
                    height={16}
                    transform="translate(-1050.65 306.43) rotate(-45)"
                  />
                </svg>
              </button>
            }
          ...
          >
            <JDslide dots={false}>
              <div className="slick-list">
                <a href="#">
                  <img src={mainvisual2} alt="sns게시물올리기"></img>
                </a>
              </div>
            </JDslide>
            <JDslide dots={false}>
      ...
      <section id="container">
        <div className="row1">
          <div className="row_tit">추천 키워드</div>
          <ul>
            <li>
              <a href="#">
                <img src={keyword1} alt=""></img>
                <span className="keyword_tit">
                  <p>국내여행</p>
                </span>
              </a>
            </li>
        ...
        <div className="row2">
          <h2 className="row_tit">알차게 #호캉스 보내기</h2>
          ...
          <ul className="row_list">
            <li>
              <a href="http://localhost:3000/#/detail">
                ...
                <span className="tit">
                  부담스럽지 않게 호캉스 제대로 즐기기!
                </span>
                <span className="profile">
                  <span className="profile_img">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 32.55 24.62"
                    >
                      <defs>
                        <style
                          dangerouslySetInnerHTML={{
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 35 29.77">
                  <defs>
                    <style
                      dangerouslySetInnerHTML={{
                        __html:
                          ".cls-4{fill:none;stroke:#bababa;stroke-miterlimit:10;stroke-width:3px;}",
                      }}
                    />
                  </defs>
                  <path
        ...
        <div className="row3">
          <h2 className="row_tit">대한민국 #야경명소 는 어디?</h2>
        ...
        <div className="row4">
          <h2 className="row_tit">인기 있는 인플루언서</h2>
          <div className="row_txt">
            가장 인기가 많았던 인플루언서들을 만나 보세요!
          </div>
          <ul>
            <li>
              <a
                href="https://www.instagram.com/janda__official/"
                target="_blank"
              >
                <span className="img">
                  <svg
                ...
                <span className="id_name">janda__official</span>
                <span className="post_wrap">
                  <span className="post">업로드</span>
        ...
        <div className="row5">
          <div className="tit_wrap">
            <div className="sns_tit">#magency</div>
            <div className="sub_tit">INSTAGRAM</div>
          </div>
          <ul>
            <li>
              <a href="#">
