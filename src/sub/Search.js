      ...
      <section id="container">
        ...
        <div className="inner">
          ...
          <div className="keyword_wrap">
            <span className="keyword_tit">인기 키워드</span>
          ...
          <div className="total_count">
            검색결과 총<span className="data">0</span>건
          </div>
          <div className="store_select">
            <select name="order_select" className="select">
              <option value="search">검색순</option>
