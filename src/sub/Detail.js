...
import "./Detail.scss";
import img from "../Detail_img/logo_1.png";
      ...
      <section id="container">
        <div className="contents">
          <div className="sharing_wrap">
            <div className="code_num">추천코드 생성</div>
            <button>공유하기</button>
          </div>
        ...
        <div className="view_wrap">
            ...
            prevArrow={
              <button className="slick-prev">
                ...
                >
                  <defs>
                    <style
                      dangerouslySetInnerHTML={{ __html: ".cls-8{fill:#ddd;}" }}
                    />
                  </defs>
                  <rect
                    className="cls-8"
          ...
          >
            <JDslide dots={false}>
              <img src={cover_img1} alt="후기이미지"></img>
            </JDslide>
            <JDslide dots={false}>
              <img src={cover_img2} alt="후기이미지"></img>
            </JDslide>
            <JDslide dots={false}>
              <img src={cover_img3} alt="후기이미지"></img>
            </JDslide>
          </JDslider>
          <div className="sub_img">
            <span>
              <img src={cover_img1}></img>
            </span>
            <span>
              <img src={cover_img2}></img>
            </span>
            <span>
              <img src={cover_img3}></img>
            </span>
          </div>
        </div>
        <div className="terms_wrap">
          <div className="inner">
            <div className="t_tit">홍보 필수 유의사항</div>
            <div className="content">
              <span>
                홍보 시작 전 <strong>메이전시 홍보 정책</strong>을 반드시
                확인하시고 참여 부탁드립니다. 이를 위반할 경우 발생한 수익금이
                전액 회수되며 해당 광고주와 법적 문제가 발생할 수 있습니다. 이에
                메이전시에서는 책임을 지지 않으며, 부정 홍보로 인하여 광고 중단
                시 메이전시에서 해당 인플루언서에게 손해 배상 청구를 진행할
                예정입니다.
              </span>
            </div>
          </div>
        ...
        <div className="tip_wrap">
          <div className="tip_tit">필수 사항</div>
          <div className="content">
            <span>&#42;상품을 직접 사용해보고 장점에 대해서 소개할 것</span>
            <span>&#42;지나친 과장홍보 금지</span>
            <span>&#42;도배 성 홍보 금지</span>
            <span>&#42;유해 사이트 홍보 시 수익금이 취소 될 수 있습니다.</span>
          </div>
        </div>
        <div className="explanation">
          <div className="ex_tit">상품 설명</div>
          <div className="content">
            <span>
              <strong>&#8211;Ideal hotel fo traveler</strong>
              <br></br>
              실용적인 편안함을 가장 합리적인 가격으로 누릴 수 있습니다.
            </span>
            <span>
              <strong>&#8211;Efficient, Convenient</strong>
              <br></br>
              언제나 편안함과 만족감이 모두 느껴지는 꼭 필요한 서비스와 실용적인
              시설을 제공합니다.
            </span>
            <span>
              <strong>&#8211;Brand Features</strong>
              <br></br>숙면을 위한 기능이 완비된 객실 : 해온 베딩, 필로우 서비스
              <br></br>스트레스 없는 비즈니스 여행 : 무료 와이파이, 디지털 기기
              대여 서비스
            </span>
          </div>
        </div>
